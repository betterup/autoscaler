...
replace k8s.io/apimachinery => k8s.io/apimachinery v0.26.2-rc.0
...
replace k8s.io/code-generator => k8s.io/code-generator v0.26.2-rc.0
...
replace k8s.io/cri-api => k8s.io/cri-api v0.26.2-rc.0
...
replace k8s.io/kube-aggregator => k8s.io/kube-aggregator v0.26.1
...
replace k8s.io/metrics => k8s.io/metrics v0.26.1
